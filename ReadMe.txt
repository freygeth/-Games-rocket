========================================================================
    APLICACIÓN: nave2.1 Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación nave2.1.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación nave2.1.
